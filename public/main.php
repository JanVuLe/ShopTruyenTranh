...
?>
    ...
    if ($hasItems) {
    ?>
        <h3><a class="text-decoration-none danhmuc" href="index.php?action=group&id=<?php echo $d["id"]; ?>">
                    ...
                    <div class="col mb-5">
                        <div class="card h-100 shadow">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-success mt-auto" href="index.php?action=chovaogio&id=<?php echo $m["id"]; ?>">Chọn mua</a></div>
                            </div>
                        </div>
                    </div>
            <?php
